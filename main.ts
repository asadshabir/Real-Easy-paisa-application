...
let user_SignUp: any = await inquirer.prompt([
  {
    name: "signUp",
    type: "input",
  ...
  },
  {
    ...
    type: "input",
    message:
      chalk.bold.magenta("Select Password :") +
      " " +
...
if (
  ...
  while (condition) {
    let loginAccount: any = await inquirer.prompt([
      {
        name: "login",
        type: "input",
    ...
    if (
      loginAccount.login === user_SignUp.signUp &&
      ...
      console.log(
        chalk.bold.green("RS :") + " " + chalk.bold.magentaBright(userBalance)
      );
      ...
      if (options.option === "Easy Load") {
        ...
        if (
          sendMoney.transferMoney === "Easy Paisa" ||
          "Jazz Cash" ||
          "Bank Account"
        ) {
          let condition4 = true;
          while (condition4) {
            let transferMoney = await inquirer.prompt([
              ...
              },
              {
                ...
                type: "number",
                message: chalk.bold.yellowBright(
                  "Enter Amount For This Transaction :"
                ),
              },
              {
                name: "conform",
                type: "confirm",
                message: chalk.redBright.italic.bold(
            ...
            if (transferMoney.transferPin === pinFunc) {
              if (transferMoney.money > userBalance) {
                ...
                console.log(
                  chalk.bold.yellow("________________________________")
                );
                ...
                console.log(
                  chalk.bold.yellowBright("From :") +
                    chalk.bold.cyan(transferMoney.trasacName)
                );

                console.log(
                  chalk.bold.italic.magenta(
                    "Your Remainig Account Balance Is"
                  ) +
                    " " +
              ...
              console.log(
                chalk.bold.blueBright("{Re- Enter Your Information}")
              );
            }
          }
        } else {
        ...
        while (loanCondition) {
          let gatLoan: any = await inquirer.prompt([
            {
              name: "takingLoan",
              type: "number",
              message: chalk.yellow.italic.bold(
                "Please Enter The Amount Of Loan You Want To Get :"
              ),
            },
            {
              name: "loanConfirm",
              ...
              message: chalk.bold.redBright(
                "Are you sure you want to get loan .?"
              ),
            },
            {
              name: "loanPin",
          ...
          if (gatLoan.takingLoan <= 50000) {
            ...
            console.log(
              chalk.yellow.bold("Congratulations .!") +
                " " +
            ...
            console.log(
              chalk.bold.greenBright("Your New Account Balance Is :") +
                " " +
            ...
            console.log(
              chalk.red.bold.italic("Your Account Limit Reached .!! ") +
                " " +
        ...
        if (
          ...
          if (
            ...
            console.log(
              chalk.bold.magenta.italic("Transaction Maker") +
                " " +
        ...
        console.log(
          chalk.bold.blueBright("Dear User") +
            ...
            chalk.bold.greenBright(loginAccount.login) +
            " " +
            chalk.bold.cyan.italic(
              "This Option Is not available one that time |"
            ) +
            " " +
        ...
        console.log(
          chalk.bold.italic.yellowBright("Your Available Account Blance is") +
            " " +
      ...
      console.log(
        chalk.bold.red("Invalid UserName or Number or Password or Pin .!!") +
          " " +
          chalk.blue.bold("try again .")
      );
      console.log("");

      let option: any = await inquirer.prompt([
        {
          name: "tryAgain",
          type: "confirm",
          message: chalk.magenta.bold(
            "Do you want to try again login process .?"
          ),
          default: true,
        },
      ]);
  ...
  console.log(
    chalk.bold.red("SignUp Faild .!! Please provide valid information")
  );
}
